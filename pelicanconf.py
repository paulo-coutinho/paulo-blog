...
# Social widget
SOCIAL = (
    ("YouTube", "https://www.youtube.com/channel/UC9rytHKniMbIxvIr6CpX6Ow"),
    ("Twitter", "https://twitter.com/prsolucoes"),
)
...
NID_COPYRIGHT = "&copy; Paulo Coutinho %s" % now.year
